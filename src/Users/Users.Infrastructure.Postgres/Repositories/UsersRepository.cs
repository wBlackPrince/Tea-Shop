...
public class UsersRepository : IUsersRepository
{
    ...
    public async Task<BasketItem?> GetBasketItemById(
        BasketItemId basketItemId,
        CancellationToken cancellationToken)
    {
        BasketItem? basketItem = await _dbContext.BasketItems
            .FirstOrDefaultAsync(u => u.Id == basketItemId, cancellationToken);
