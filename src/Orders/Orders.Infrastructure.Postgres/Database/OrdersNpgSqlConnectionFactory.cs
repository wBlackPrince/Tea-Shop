...
public class OrdersNpgSqlConnectionFactory: IDisposable, IAsyncDisposable, IDbConnectionFactory
{
    private readonly NpgsqlDataSource _dataSource;

    public OrdersNpgSqlConnectionFactory(IConfiguration configuration)
    {
